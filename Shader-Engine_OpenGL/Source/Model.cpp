...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene){
    ...
    // Process Materials :
    // Retrive the material of this mesh if it exists.
    if (mesh->mMaterialIndex >= 0){
        aiMaterial* material = scene->mMaterials[mesh->mMaterialIndex];

        // Load each texture type from their material and append the result onto the texture vector
...
// TODO : Replace with own function from Texture Class.
